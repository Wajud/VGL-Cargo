...
import { Wrench, Bolt, ShoppingCart, Zap, ShieldCheck, CheckCircle } from "lucide-react";
import qualityAssurance from "../assets/quality assurance.jpg"
import reliableExpertise from "../assets/reliable expertise.jpg"
...
description: "Efficient coordination and supervision of electrical installation projects." 
},
  {
id: 1,
icon: <Bolt size={40} className="text-blue-500" />,
title: "Electrical Installations",
description: "Reliable power solutions for optimal energy efficiency and sustainability." 
},
  {
id: 2,
icon: <ShoppingCart size={40} className="text-blue-600" />,
title: "Sales and Procurement",
description: "Sourcing and supplying quality electrical components and materials." 
}
]
...
const benefits = [
  {
    ...
    description: "We adhere to the highest safety standards to ensure secure installations, minimizing risks and ensuring regulatory compliance in all projects." ,
    image: safetyAndCompliance
  },
  {
    icon: <Zap size={40} className="text-yellow-500" />, 
    title: "Reliable Expertise", 
    description: "Our team brings years of experience in electrical installation and management, delivering professional solutions tailored to meet client-specific needs." ,
    image: threeHelmets
  },
  {
    icon: <CheckCircle size={40} className="text-green-600" />, 
    title: "Quality Assurance", 
    description: "We use top-tier materials and best practices to deliver outstanding results, ensuring durability, efficiency, and long-term performance in every project." ,
    ...
    <section className="relative w-full h-screen flex items-center justify-center bg-gray-900 text-white overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 md:px-12">
        ...
        <p className="mt-4 text-lg md:text-xl max-w-2xl mx-auto">
          Reliable electrical site management, power solutions, and seamless procurement services for your projects.
        </p>
      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {services.map((service, index) =>
           (
            <div key={index} className="p-6 bg-white rounded-2xl shadow-lg flex flex-col items-center text-center relative hover:scale-105 transition-all">
          ...
          {benefits.map((benefit, index) => (
            <div
              ...
              className={`absolute transition-all duration-700 transform pt-60 pb-40 ${
                index === activeIndex ? "scale-100 opacity-100" : "scale-50 opacity-0"
              }`}
            >
              {/* <div className="p-6 bg-white rounded-2xl shadow-lg flex flex-col items-center text-center">
              ...
              <div className="mt-44 md:mt-0 flex flex-col md:flex-row gap-6 items-center text-center md:text-left">
                <img src={benefit.image} alt={`${benefit.image} image`} className="w-60 h-60 rounded-md object-cover" />
                <div className="mt-4 md:mt-0">
                <h3 className="text-3xl font-semibold text-gray-600 mb-6">{benefit.title}</h3>
